...
const bloodRequestsRoutes = require('./routes/bloodRequests');  // Added blood requests routes
...
app.use('/api/hospitals', hospitalsRoutes);       // Hospital routes
app.use('/api/blood-requests', bloodRequestsRoutes); // Blood Requests routes (added)
